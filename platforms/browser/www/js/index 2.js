...
function eurtousd() { 
    ...
    http.onreadystatechange = (e) => {
        ...
        var converted = currencyAmount / eurInUsd;
        document.getElementById('pos1').innerHTML = 'Your converted currency is : '+converted+' dollars';
    }
};
...
function usdtoeur() { 
    ...
    http.onreadystatechange = (e) => {
        ...
        var converted = currencyAmount * usdInEur;
        document.getElementById('pos2').innerHTML = 'Your converted currency is : '+converted+' euros';
    }
};
